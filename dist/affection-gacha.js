(function () {
  ...
  function renderPull(pull) {
    ...
    if (pull.photo) {
      const altText = pull.photo.alt || "Foto von uns";
      let mediaEl;
      if (pull.photo.type === "video") {
        mediaEl = document.createElement("video");
        mediaEl.src = pull.photo.url;
      ...
      photoMedia.appendChild(mediaEl);
